...
# PARAMETERS EXP
# presentation
# stim_IDs = [2, 3, 6, 8, 10, 11, 12, 13, 14, 15, 17, 18, 20] # short version (31.2*2+16.5 ~1h20min) # 13 stimuli
stim_IDs = [1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 17, 18, 19, 20] # long version (43*2+20 ~1h50min) # 18 stiumuli
folder_input = './input/'
stim_types = ['song', 'speech']  #['melody', 'song', 'speech'] # 43 + 20 = 1h03 of experiment, 18 stimuli in each block
string_1st_slide = 'songs and speech' #'songs, speech, and melodies'
nr_blocks = 2
